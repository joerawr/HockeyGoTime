...
export const KEY_PATTERNS = {
   ...
   * @param date - Date in YYYY-MM-DD format
   * @returns Redis key (e.g., "analytics:tokens:gemini-3-flash:input:daily:2025-10-15")
   */
   ...
   * @param modelName - AI model identifier (e.g., "gemini-3-flash")
   * @param date - Date in YYYY-MM-DD format
   * @returns Redis key (e.g., "analytics:tokens:gemini-3-flash:output:daily:2025-10-15")
   */
